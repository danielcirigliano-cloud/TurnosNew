...
<main class="flex-1 p-6 overflow-y-auto relative w-full">
    ...
    <section id="sFlota" class="tab-content mt-8 w-full">
        ...
        <p class="text-xs text-slate-400 mb-4">Conectado a: <span class="text-sky-400">/sites/GestiondeTurnos/Lists/Vehculos</span></p>
        <div class="glass p-6 rounded-xl mb-6 border border-slate-700 w-full text-sm">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <!-- Listas SP directas -->
					<div class="flex gap-2 mb-4">
						<button onclick="importarCSVFlota()" 
							class="bg-emerald-600 hover:bg-emerald-500 text-white px-4 py-2 text-xs font-bold rounded shadow">
							Subir CSV Flota
						</button>
					</div>
                <div class="bg-slate-900 border border-slate-700 rounded-lg p-4 flex items-center justify-between">
