...
<main class="flex-1 p-6 overflow-y-auto relative w-full">
        ...
        <div class="flex flex-col gap-4">
            <div class="grid grid-cols-12 gap-4 h-[calc(100vh-130px)]">
                ...
                <div class="col-span-8 glass p-4 rounded-xl flex flex-col h-full">
                    <div class="flex gap-2 mb-4 items-end bg-slate-900/50 p-3 rounded-lg border border-slate-700 shrink-0">
                        <div>
    ...
    <!-- SECCION 8: CONFIGURACION DE HORARIOS -->
    ...
    <section id="s9" class="tab-content mt-8 w-full">
        ...
        <div class="w-full grid grid-cols-2 gap-8">
            ...
            <div class="glass p-8 rounded-xl flex flex-col h-[600px]">
                ...
                <div class="flex-1 bg-black/80 rounded border border-slate-700 p-4 font-mono text-xs overflow-y-auto" id="etl-log-console" style="color:#4ade80"><div>> Inicializando motor ETL Audit v6.1...</div></div>
            </div>
        </div>
    </section>

    <!-- SECCION 10: DASHBOARD INDICADORES -->
...
<script>
    ...
    function generarResumenDiario() {
        ...
        if(htmlResumen === '') {
            htmlResumen = '<tr><td colspan="6" class="p-6 text-center text-slate-500 text-sm">No hay actividad logistica en esta fecha.</td></tr>';
        } else {
