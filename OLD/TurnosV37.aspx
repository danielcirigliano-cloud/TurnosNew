            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="bg-slate-900 border border-slate-700 rounded-lg p-4 flex items-center justify-between">
                    <div>
                        ...
                        <div class="text-xs text-slate-400 font-mono">Lists/Vehiculos</div>
...
<script>
    ...
    async function cargarFlotaSP() {
        try {
            const res = await fetchSPLista(LISTA_FLOTA, 'items?$select=Id,Patente,TipoVehiculo,Empresa,CUITEmpresa,HabVto,Estado&$orderby=Patente&$top=500');
            ...
            listaFlotaCache = (data.value || []).map(v => ({
                ...
                empresa: v.Empresa     || '',
                cuit:    v.CUITEmpresa || '',
                vto:     v.HabVto      ? v.HabVto.split('T')[0] : '',
    ...
    function renderizarBaseFlota() {
        ...
        tbody.innerHTML = listaFlotaCache.map((v, i) => `
            <tr class="border-b border-slate-700/50 hover:bg-slate-800/30 text-sm">
                ...
                <td class="px-3 text-slate-400 text-xs">${escapeHtml(v.vto)}</td>
    ...
    async function guardarVehiculo() {
        ...
        const payload = {
            ...
            HabVto:       document.getElementById('fl_vto').value || null,
